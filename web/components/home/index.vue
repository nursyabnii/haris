        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-10">
                    ...
                    <h2 class="font-bold text-dark text-3xl mb-5 max-w-md">Learning is beautiful</h2>
                    <p class="font-medium text-base text-secondary max-w-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus incidunt, iusto repellat id laboriosam saepe, quas voluptates, exercitationem vel labore cumque officia sed aliquid reiciendis? Voluptatum, enim placeat. Eius, adipisci.</p>
                </div>
                <div class="w-full px-4">
                    <h3 class="font-semibold uppercase text-dark text-2xl mb-4">Let's be friends</h3>
                    <p class="font-medium text-base text-secondary mb-6">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut aperiam non neque labore quae, quam, eveniet recusandae, provident repellat quasi maiores natus. Quos at, possimus officia deleniti beatae veniam nulla!</p>
                </div>
            </div>
        </div>
    </section>
