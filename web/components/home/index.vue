        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    <h1 class="text-base font-semibold text-primary md:text-xl lg:text-2xl">Hello Everyone 👋, Saya <span class="block font-bold text-dark text-4xl">Muhammad Nur Sya'bani Haris</span> </h1>
                    <h2 class="font-medium text-slate-500 text-lg mb-5">Web Developer & <span class="text-dark">Unity Programmer</span></h2>
                    <p class="font-medium text-slate-400 mb-10 leading-relaxed">Learning web programming & unity programming is easy and fun, <span class="text-dark font-bold">isn't it!</span></p>
