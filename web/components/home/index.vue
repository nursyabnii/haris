<template>
        ...
        <div class="flex flex-wrap">
            <div class="w-full px-4 lg:w-1/2 xl:w-1/3" >
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10 dark:bg-slate-800">
                    ...
                    <div class="py-8 px-6">
                        <UBadge class="px-4 mb-4 text-base font-semibold dark:text-white">New Update</UBadge>
                        <h3>
    ...
    <!-- Back To Top Start -->
    <a href="#home" id="to-top" class="bg-opacity-60 animate-bounce hidden h-14 w-14 bg-primary rounded-full items-center justify-center fixed z-[9999] bottom-4 right-4 p-4 hover:animate-pulse hover:cursor-pointer"><span class="block h-5 w-5 border-t-2 border-l-2 rotate-45 mt-2"></span></a>
    <!-- Back To Top End -->
</template>
...
export default {
  ...
  mounted() {
    ...
    window.addEventListener('scroll', function () {
        ...
        const yPos = window.pageYOffset * 0.5; // Adjust the parallax effect by changing the multiplier
