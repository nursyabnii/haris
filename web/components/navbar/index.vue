<template>
    <header class="bg-transparant navbar-fixed top-0 left-0 w-full flex items-center z-10">
        <div class="container">
            <div class="div flex items-center justify-between relative">
                <div class="px-4">
                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#contact" class="text-base text-dark py-2 mx-8 flex group-hover:text-primary">Contact Me</a>
                            </li>
                        </ul>
                    </nav>
                </div>
